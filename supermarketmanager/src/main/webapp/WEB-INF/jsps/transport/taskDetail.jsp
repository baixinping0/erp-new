...
<div class="content-right">
	...
	<div class="content-text">
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td class="order_show_msg">${order.orderTypeView}</td>
						<td>提货方式:</td>
						<td class="order_show_msg">${order.supplier.needsView}</td>
						<td>订 单 号:</td>
						<td class="order_show_msg" colspan="2">${order.orderNum}</td>
					</tr>
					<tr>
						<td>联&nbsp;系&nbsp;人:</td>
						<td class="order_show_msg">${order.supplier.contact}</td>
						<td>联系方式:</td>
						<td class="order_show_msg">${order.supplier.tele}</td>
						<td>商品总量:</td>
			...
			<div class="square-order">
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="order.orderDetails">
						<tr align="center" bgcolor="#FFFFFF">
							<td height="30">${goods.goodsType.name }</td>
							<td>${goods.name }</td>
							<td>${num}</td>
						</tr>
					</s:iterator>
				...
				<s:hidden name="order.uuid"/>
				<table width="100%">
					<tr>
						<td width="50%" align="right">
							<s:select name="order.completer.uuid" list="empList" listKey="uuid" listValue="name" cssStyle="width:100px;font-size:20px">
							</s:select>
						</td>
