		...
		<form action="list.jsp" method="post"> 
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td width="10%">仓库名称:</td>
						<td width="20%"><input type="text" size="8" /></td>
						<td width="10%">容&nbsp;&nbsp;积&nbsp;&nbsp;量:</td>
						<td width="20%"><input type="text" size="8" />&nbsp;米<sup>3</sup>&nbsp;</td>
						<td width="3%">到</td>
						<td width="26%"><input type="text" size="8" />&nbsp;米<sup>3</sup>&nbsp;</td>
						<td width="">
					...
					<tr>
						...
						<td>当前容积量：</td>
						<td><input type="text" size="8" />&nbsp;米<sup>3</sup>&nbsp;</td>
						<td>到</td>
						<td><input type="text" size="8" />&nbsp;米<sup>3</sup>&nbsp;</td>
						<td>
