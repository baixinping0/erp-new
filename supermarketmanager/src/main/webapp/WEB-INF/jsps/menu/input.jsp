		...
		<div class="square-order">
			...
			<s:hidden name="menu.uuid"/>
  			<div style="border:1px solid #cecece;">
				...
				<table width="100%"  border="0" cellpadding="0" cellspacing="0">
				    <tr  bgcolor="#FFFFFF">
				      <td width="18%" height="30" align="center">菜单名称
				      </td>
				      <td width="32%">
				      ...
				      <td width="32%">
				      <s:select  style="width:190px" name="menu.parent.uuid" list="oneLevelMenuList" listKey="uuid" listValue="name"/>
				      </td>
				    </tr>
				    <tr  bgcolor="#FFFFFF">
				      <td colspan="4">&nbsp;</td>
