...
<script type="text/javascript">
	...
	function showMsg(msg, uuid) {
		...
		top.$('hid-action').value = "/erp/goodsType_delete?goodsType.uuid="
				+ uuid;
		top.lock.show();
	}
</script>
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="123">&nbsp;</td>
						<td width="62">供应商:</td>
						<td width="142"><s:select cssClass="kuan"
								name="goodsTypeq.supplier.uuid" list="supplierList"
								listKey="uuid" listValue="name" headerKey="-1"
								headerValue="--请-选-择--" /></td>
						<td width="60">类别名称:</td>
						<td width="149">
							<s:textfield name="goodsTypeq.name" size="18"/>
						</td>
						...
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td><img src="images/icon_3.gif" /> <span
								style="line-height:12px; text-align:center;"> <s:a
										action="goodsType_input" cssClass="xiu">修改
										<s:param name="goodsType.uuid" value="uuid" />
									</s:a>
							</span> <img src="images/icon_04.gif" /> <span
								style="line-height:12px; text-align:center;"> <a
									href="javascript:void(0)" class="xiu"
									onclick="showMsg('是否删除该项数据？',${uuid})">删除</a>
							</span></td>
						</tr>
					</s:iterator>
				</table>
