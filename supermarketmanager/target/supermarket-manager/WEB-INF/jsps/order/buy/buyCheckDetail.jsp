			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td>下单时间:</td>
						<td class="order_show_msg">${order.createTimeView}</td>
						<td>下 单 人:</td>
						<td class="order_show_msg">${order.creater.name}</td>
						<td>订 单 号:</td>
					...
					<tr>
						...
						<td>订单总额:</td>
						<td class="order_show_msg">${order.totalPriceView} 元</td>
					</tr>
				</table>
			</div>
			<!--"square-o-top"end-->
			<div class="square-order">
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<tr align="right">
						...
						<td width="20%">${order.totalPriceView} 元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					</tr>
				</table>
				<br/>
				<table width="100%">
