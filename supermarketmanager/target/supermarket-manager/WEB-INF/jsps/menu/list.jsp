...
<script type="text/javascript">
	...
	function showMsg(msg,uuid){
		...
		top.$('hid-action').value="/erp/menu_delete?menu.uuid=" + uuid;
		top.lock.show();
	}
</script>
			...
			<div class="square-o-top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td width="62">菜单名称</td>
						<td width="142">
							<s:textfield size="18" name="menuq.name"/>
						</td>
						<td width="60">所属菜单</td>
						<td width="149">
						<s:select name="menuq.parent.uuid" cssClass="kuan" list="oneLevelMenuList" 
				...
				<table width="100%" border="1" cellpadding="0" cellspacing="0">
					...
					<s:iterator value="menuList">
						...
						<td>
							...
							<s:a action="menu_input" cssClass="xiu">修改
								<s:param name="menu.uuid" value="uuid"/>
							</s:a>
							</span> 
