				...
				<div style="border:1px solid #cecece;">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr bgcolor="#FFFFFF">
							...
							<td width="32%">
								<s:textfield name="emp.userName" size="25"/>
								</td>
							<td width="18%" align="center">真实姓名</td>
							<td width="32%"><s:textfield name="emp.name" size="25"/>
							</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td colspan="4">&nbsp;</td>
						...
						<tr bgcolor="#FFFFFF">
							...
							<td><s:textfield name="emp.pwd" size="25"/>  </td>
						...
						<tr bgcolor="#FFFFFF">
							...
							<td><s:textfield name="emp.email"/>
							<td align="center">电话号码</td>
							<td>
							<s:textfield name="emp.tele" size="25"/>
							</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td colspan="4">&nbsp;</td>
						...
						<tr bgcolor="#FFFFFF">
							...
							<td>
							<s:select name="emp.gender" list="@com.bxp.erp.auth.emp.vo.EmpModel@genderMap" />
							</td>
							<td align="center">地&nbsp;&nbsp;&nbsp;&nbsp;址</td>
							<td>
								<s:textfield name="emp.address" size="25"/>
							</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td colspan="4">&nbsp;</td>
						...
						<tr bgcolor="#FFFFFF">
							...
							<td><input type="text" size="25"
								onfocus="c.showMoreDay=false;c.show(this);" readonly="true" value="${emp.birthdayView}"/>
								 <s:hidden name="emp.birthday" />
								 </td>
							<td align="center">所属部门</td>
							<td>
							<s:select name="emp.dep.uuid" list="depList" listKey="uuid" listValue="name" cssStyle="width:190px"></s:select>
							</td>
						</tr>
						<tr bgcolor="#FFFFFF">
							<td colspan="4">&nbsp;</td>
